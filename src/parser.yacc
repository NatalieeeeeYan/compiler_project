...
| SUB UNUM  
{
  $$ = (A_tokenNum) malloc(sizeof(struct A_tokenNum_));
  $$->pos = $2->pos;
  $$->num = -($2->num); 
}
;
...
// IfStmt: IF LEFT_PARENTHESIS BoolUnit RIGHT_PARENTHESIS OPEN_BRACE CodeBlockStmtList CLOSED_BRACE
IfStmt: IF BoolUnit OPEN_BRACE CodeBlockStmtList CLOSED_BRACE
{
  $$ = A_IfStmt($1, $2, $4, NULL);
}
// | IF LEFT_PARENTHESIS BoolUnit RIGHT_PARENTHESIS OPEN_BRACE CodeBlockStmtList CLOSED_BRACE ELSE OPEN_BRACE CodeBlockStmtList CLOSED_BRACE
| IF BoolUnit OPEN_BRACE CodeBlockStmtList CLOSED_BRACE ELSE OPEN_BRACE CodeBlockStmtList CLOSED_BRACE
{
  $$ = A_IfStmt($1, $2, $4, $8);
}
;
// WhileStmt: WHILE LEFT_PARENTHESIS BoolUnit RIGHT_PARENTHESIS OPEN_BRACE CodeBlockStmtList CLOSED_BRACE
WhileStmt: WHILE BoolUnit OPEN_BRACE CodeBlockStmtList CLOSED_BRACE
{
  $$ = A_WhileStmt($1, $2, $4);
}
;
...
;
BoolUnit: LEFT_PARENTHESIS ExprUnit ComOp ExprUnit RIGHT_PARENTHESIS
{
...
// BoolUnit_: LEFT_PARENTHESIS ExprUnit ComOp ExprUnit RIGHT_PARENTHESIS
// {
//     $$ = A_BoolExprUnit($1, A_ComExpr($1->pos, $2, $3, $4));
// }
// | LEFT_PARENTHESIS BoolExpr RIGHT_PARENTHESIS
// {
//     $$ = A_BoolExprUnit($1, $2);
// }
// | LEFT_PARENTHESIS NOT BoolUnit RIGHT_PARENTHESIS
// {
//     $$ = A_BoolUOpExprUnit($1, A_BoolUOpExpr($1, A_not, $2));
// }
// ;
